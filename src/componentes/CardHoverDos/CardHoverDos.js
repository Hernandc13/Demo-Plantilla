...
import "./CardHoverDos.css";

import { initialListCardHover } from "./EditCardHoverDos";
import { CardHover2Styles } from "./EditCardHoverDos";

export default function CardHoverDos({ enviarDatos, enviarDatos2, enviarDatos3, i }) {
  ...
  const [counterCardHoverDos, setCounterCardHoverDos] = useState(0);

  const RenderCardsHoverDos = ({card}) => {
